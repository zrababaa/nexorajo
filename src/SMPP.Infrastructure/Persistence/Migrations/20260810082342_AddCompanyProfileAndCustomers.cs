...
{
    /// <inheritdoc />
    public partial class AddCompanyProfileAndCustomers : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RegistrationId = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CompanyProfiles_AspNetUsers_AccountId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CompanyDocuments_AspNetUsers_AccountId",
                        column: x => x.AccountId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompanyDocuments_AccountId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompanyProfiles_AccountId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Customers_AccountId_Status",
                table: "Customers",
